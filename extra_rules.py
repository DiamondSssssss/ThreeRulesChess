...
def rule_info(rule_id: str) -> dict | None:
    """Trả dict {id, name, description} hoặc None."""
...
def all_rule_infos() -> list[dict]:
    """Trả danh sách tất cả luật (id, name, description)."""
    return [{"id": r["id"], "name": r["name"], "description": r["description"]} for r in ALL_RULES]
